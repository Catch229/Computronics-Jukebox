...
function updateTapeSong()
	...
	trackLbl.updateTxt(trackLbl, trackNames[currentTrack])
end
...
function getHeaderFromTape()
	...
	gui.createHeader("Catch's MP3 Player", 1, 1, gui.w)
	...
	lbl = gui.createLabel("Repeat Mode: ", 13, gui.h-8, 13)
	lbl2 = gui.createLabel(modes[currentMode], 14, gui.h-7, 13)
	trackLbl = gui.createLabel(trackNames[currentTrack], 1, gui.h-10, 28, colors.lightBlue, colors.white)
